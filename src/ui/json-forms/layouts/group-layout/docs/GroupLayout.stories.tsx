import { GroupLayoutRenderer } from '..';
...
const meta: Meta<typeof GroupLayoutRenderer> = {
    title: 'JSONForms/Layouts/GroupLayout',
    component: GroupLayoutRenderer,
    args: {
        schema,
    },
    parameters: {
...
export const FieldWidth: StoryFn<JsonFormsInitStateProps & JsonFormsReactProps> = ({ schema }) => {
