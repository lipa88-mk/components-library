import { CategorizationLayoutRenderer } from '..';
...
const meta: Meta<typeof CategorizationLayoutRenderer> = {
    title: 'JSONForms/Layouts/CategorizationLayout',
    component: CategorizationLayoutRenderer,
    args: {
        schema,
        uischema,
    },
...
export const Layout: StoryFn<JsonFormsInitStateProps & JsonFormsReactProps> = ({ schema, uischema }) => {
